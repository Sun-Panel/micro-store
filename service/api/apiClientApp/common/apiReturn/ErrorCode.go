...
const (
	...
	ErrCodeTokenExpires = 1001 // token过期
	ErrCodeTokenInvalid = 1002 // token无效
...
var ErrorCodeMap = map[int]error{
	...
	ErrCodeTokenExpires: errors.New("token expires"), // 还未登录
	ErrCodeTokenInvalid: errors.New("token invalid"),
