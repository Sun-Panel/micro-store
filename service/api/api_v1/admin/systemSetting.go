...
func (a *SystemSettingApi) SetEmail(c *gin.Context) {
	...
	if err := global.SystemSetting.Set("system_email", param); err != nil {
...
func (a *SystemSettingApi) GetEmail(c *gin.Context) {
	...
	if err := global.SystemSetting.GetValueByInterface("system_email", &info); err != nil && err != systemSetting.ErrorNoExists {
...
func (a *SystemSettingApi) SetApplicationSetting(c *gin.Context) {
	...
	if err := global.SystemSetting.Set("system_application", param); err != nil {
...
func (a *SystemSettingApi) GetApplicationSetting(c *gin.Context) {
	...
	if err := global.SystemSetting.GetValueByInterface("system_application", &info); err != nil && err != systemSetting.ErrorNoExists {
