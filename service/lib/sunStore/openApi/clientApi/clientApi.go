...
func NewClientAPI(Host, accessToken string) *ClientAPI {
	clientAPI := ClientAPI{}
	clientAPI.AccessToken = accessToken
	clientAPI.Host = Host

	return &clientAPI
}

func (o *ClientAPI) Post(url string, requestData interface{}, responseData interface{}) (httpCode int, apiCode int, err error) {
...
func (o *ClientAPI) GetHost() string {
